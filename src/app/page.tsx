...
export default function Home() {
    return (
        <>
            ...
            <div className='shadow-lg rounded-xl py-8 px-5 md:px-10 text-center w-[85vw] mx-auto max-w-7xl -mt-8 bg-white relative'>
            ...
            <div className='bg-gray-50 my-12'>
                <div className='py-10 flex flex-col md:flex-row gap-5 md:gap-8 lg:gap-32 items-start justify-between w-[85vw] mx-auto max-w-7xl'>
            ...
            <div className='grid grid-rows-3 md:grid-rows-1 md:grid-cols-3 md:flex-row gap-8 w-[85vw] mx-auto max-w-7xl mt-10 mb-16'>
