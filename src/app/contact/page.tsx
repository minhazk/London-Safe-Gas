...
import { address, contactNumber, landlineNumber } from '@/data';
        ...
        <>
            ...
            <section className='mt-5 mb-12 grid gap-7 md:grid-cols-2'>
                <div className='lg:py-10'>
                    ...
                    <p className='text-md my-2 text-secondary font-semibold'>
                        {contactNumber} <span className='text-gray-400 font-normal'>/</span> {landlineNumber}
                    </p>
                    {/* <p className='text-md my-2 text-secondary font-semibold'>{landlineNumber}</p> */}
