...
export function Footer() {
    return (
        <footer className='mb-16 mt-8 px-10 grid justify-center text-left grid-cols-2 md:grid-cols-[1fr_auto_auto] gap-8 items-center md:w-[90vw] max-w-[1360px] mx-auto'>
            <div>
